...
.overview-wrap{
    background-image: url(img/meghalaya/banner-.jpg);
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Meghalaya Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Meghalaya Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Meghalaya Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning"  id="state">
                                                <thead>
                                                    <tr>
                                                        <th class="bg-secondary">S.No</th>
                                                        <th class="bg-info">State Name</th>
                                                        <th class="bg-warning">Confirmed Cases</th>
                                                        <th class="bg-primary">Active Cases</th>
                                                        <th class="bg-success">Recovered Cases</th>
                                                        <th class="bg-danger">Death Cases</th>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Meghalaya</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning"  id="test">
                                                <thead>
                                                    <tr>
                                                        <th class="bg-secondary">S.No</th>
                                                        <th class="bg-primary">Date</th>
                                                        <th class="bg-info">Total Tests</th>
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1aOTWRdG6I8N-_rG14MTCwk4Dtumb94iB" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
                                    ...
                                    <div class="au-task js-list-load">
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            ...
                                            <!-- <div class="au-task__item au-task__item--warning">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Puducherry witnesses reverse trend: liquor now smuggled in from Tamil Nadu.</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="au-task__item au-task__item--primary">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">The Cabinet has come out with a fresh proposal recommending a three-tier tax structure for Indian Made Foreign Liquor in the Union Territory.</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="au-task__item au-task__item--success">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Puducherry Road Transport Corporation resumes bus services on select routes</a>
                                                    </h5>
                                                </div>
                                            </div> -->
                                        </div>
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(704593));
