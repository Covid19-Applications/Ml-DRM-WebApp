        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-covid">Medical</li>
              <li data-filter=".filter-grocery">Auxilary</li>
            </ul>
          </div>
        </div>
    ...
    <section id="services" class="services">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-covid" >
            <div class="portfolio-wrap text-center">
              <div class="card" style="height: 300px;"> <?php  echo $row['image']; ?></div>
              <div class="info">
          ...
          ?>
           ...
           <?php
            if(mysqli_num_rows($query_run) > 0)        
            {
              ...
              {
            ?>
        <div class="col-lg-4 col-md-6 portfolio-item filter-grocery" >
            <div class="portfolio-wrap text-center">
              <div class="card" style="height: 300px;"> <?php  echo $row['image']; ?></div>
              <div class="info">
                <h4 style="font-size: 18px;"><?php  echo $row['text']; ?></h4>
