...
<div class="container-fluid gtco-banner-area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card"><img class="card-img-top img-fluid" src="img/donate/donate1.jpg" alt=""></div>
            </div>
...
<!-- 
                                  ...
                                  <?php
                                        ...
                                        $query = "SELECT * FROM orphanage WHERE state = 'meghalaya' ";
                                    ...
                                    <br>
                                     ...
                                     <thead>
                                              ...
                                              <th  class="bg-info">Donation Link</th>
