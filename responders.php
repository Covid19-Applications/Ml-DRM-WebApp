          ...
          <br><br><br><br>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                      <br><br>
                        <img src="img/responders/bg.png" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="container box_1170">
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM police_emergency WHERE state = 'meghalaya'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
                                    <table class="table table-borderless table-striped table-earning" >
                                                <thead>
                                                    <tr>
                                                        <th class="bg-info">Police Station Name</th>
                                                        <th class="bg-secondary" >Contact No.</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="state-wise">
                           ...
                           <div class="card col-lg-12"  style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM ambulance_emergency WHERE state = 'meghalaya'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
                                    <table class="table table-borderless table-striped table-earning"  >
                                                <thead>
                                                    <tr>
                                                        <th class="bg-info">Ambulance Service Names</th>
                                                        <th class="bg-secondary">Contact No.</th>
                                                    </tr>
                                                </thead>
                                                <tbody >
                         ...
                         <div class="card col-lg-12" style="padding: 25px;">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                     <?php
                                                  $query = "SELECT * FROM fire_emergency WHERE state = 'meghalaya'";
                                                  $query_run = mysqli_query($connection, $query);
                                              ?>
                                    <table class="table table-borderless table-striped table-earning"  id="state-wise">
                                                <thead>
                                                    <tr>
                                                        <th class="bg-info">Fire Brigade Name</th>
                                                        <th class="bg-secondary">Contact No.</th>
                                                    </tr>
                                                </thead>
                                                <tbody >
