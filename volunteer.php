...
<br><br><br>
<img src="img/volunteer/covid.jpg" style="height: auto; width: 100%; margin-top: 5px;" id="icons">
...
<div class="card-deck">
  <div class="card  text-center INDIVIDUALS">
    ...
    <div class="card-body">
          <i class="fas fa-user" style="height: 80px; width: 54px; padding-top: 15px; " ></i>
  ...
  <div class="card text-center ORGANISATIONS ">
    <div class="card-body">
          <i class="far fa-building"  style="height: 80px; width: 54px; padding-top: 15px;"></i>
